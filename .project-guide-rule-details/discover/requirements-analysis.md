...
- Load `guide-docs/discover/reverse-engineering/architecture.md`
- Load `guide-docs/discover/reverse-engineering/component-inventory.md`
- Load `guide-docs/discover/reverse-engineering/technology-stack.md`
...
### Step 6: Generate Clarifying Questions (PROACTIVE APPROACH)
   - **ALWAYS** create `guide-docs/discover/requirements/requirement-verification-questions.md` unless requirements are exceptionally clear and complete
...
### Step 7: Generate Requirements Document
   - Create `guide-docs/discover/requirements/requirements.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the requirements document at: `guide-docs/discover/requirements/requirements.md`
...
**Note**: Include the "Add User Stories" option only when User Stories stage will be skipped. Replace [User Stories/Workflow Planning] with the actual next stage name.
   ...
   - Update Requirements Analysis stage complete in guide-state.md