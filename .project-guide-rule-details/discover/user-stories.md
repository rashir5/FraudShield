...
3. **Document Assessment Decision**:
   - Create `guide-docs/discover/plans/user-stories-assessment.md`
...
**See `common/query-standards.md` for question formatting rules**
...
- **ALWAYS** include these mandatory artifacts in the story plan:
  ...
  - [ ] Generate guide-docs/discover/user-stories/user-journey.md using Mermaid syntax to visualize the primary user workflows and touchpoints
...
- Save the complete story plan with embedded questions in `guide-docs/discover/plans/` directory
...
- [ ] Read the complete story plan from `guide-docs/discover/plans/story-generation-plan.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the user stories and personas at: `guide-docs/discover/user-stories/stories.md` and `guide-docs/discover/user-stories/personas.md`
...
- Mark User Stories stage complete in `guide-state.md`
