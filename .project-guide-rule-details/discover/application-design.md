...
**Note**: Detailed business logic design happens later in Functional Design (per-unit, BUILD phase)
...
### 1. Analyze Context
- Read `guide-docs/discover/requirements/requirements.md` and `guide-docs/discover/user-stories/stories.md`
...
- Save as `guide-docs/discover/plans/application-design-plan.md`
...
### 10. Generate Application Design Artifacts with mermaid diagrams
- For every architectural artifact, generate a corresponding Mermaid diagram (e.g., C4 Component diagrams or Sequence diagrams for services) to ensure structural clarity
- Execute the approved plan to generate design artifacts
- Create `guide-docs/discover/application-design/components.md` with:
  - Component name and purpose
  - Component responsibilities
  - Component interfaces
- Create `guide-docs/discover/application-design/component-methods.md` with:
  - Method signatures for each component
  - High-level purpose of each method
  - Input/output types
  - Note: Detailed business rules will be defined in Functional Design (per-unit, BUILD phase)
- Create `guide-docs/discover/application-design/services.md` with:
  - Service definitions
  - Service responsibilities
  - Service interactions and orchestration
- Create `guide-docs/discover/application-design/component-dependency.md` with:
  - Dependency matrix showing relationships
  - Communication patterns between components
  - Data flow diagrams

### 11. Log Approval
- Log approval prompt with timestamp in `guide-docs/audit.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the application design artifacts at: `guide-docs/discover/application-design/`
...
> ✅ **Approve & Continue** - Approve design and proceed to **[Units Generation/BUILD PHASE]**
```
...
- Log the user's approval response with timestamp in `guide-docs/audit.md`
- Include the exact user response text
- Mark the approval status clearly

### 15. Update Progress
- Mark Application Design stage complete in `guide-docs/guide-state.md`
