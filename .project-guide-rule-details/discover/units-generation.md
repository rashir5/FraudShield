...
- [ ] Generate `guide-docs/discover/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `guide-docs/discover/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `guide-docs/discover/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `guide-docs/discover/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in guide-docs/discover/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- Mark Units Planning complete in guide-state.md
...
- [ ] Read the complete plan from `guide-docs/discover/plans/unit-of-work-plan.md`
...
- [ ] Update `guide-docs/guide-state.md` current status
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `guide-docs/discover/application-design/`
...
> ✅ **Approve & Continue** - Approve units and proceed to **BUILD PHASE**
```
...
- Mark Units Generation stage complete in `guide-docs/guide-state.md`
- Update the "Current Status" section
- Prepare for transition to BUILD PHASE
