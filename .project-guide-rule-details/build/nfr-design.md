...
- Read NFR requirements from `guide-docs/build/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `guide-docs/build/plans/{unit-name}-nfr-design-plan.md`
...
### Step 6: Generate NFR Design Artifacts with Mermaid diagrams
- Create `guide-docs/build/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `guide-docs/build/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `guide-docs/build/[unit-name]/nfr-design/`
...
- Mark NFR Design stage complete in guide-state.md
