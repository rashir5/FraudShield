...
- [ ] Read workspace root and project type from `guide-docs/guide-state.md`
...
- [ ] Document exact paths (never guide-docs/)
...
- [ ] Save complete plan as `guide-docs/build/plans/{unit-name}-code-generation-plan.md`
...
- [ ] Before asking for approval, log the prompt with timestamp in `guide-docs/audit.md`
...
- [ ] Mark Code Planning complete in `guide-state.md`
...
- [ ] Read the complete plan from `guide-docs/build/plans/{unit-name}-code-generation-plan.md`
- [ ] Identify the next uncompleted step (first [ ] checkbox)
- [ ] Load the context for that step (unit, dependencies, stories)

## Step 11: Execute Current Step
- [ ] Verify target directory from plan (never guide-docs/)
...
- [ ] Write to correct locations:
  ...
  - **Documentation**: `guide-docs/build/{unit-name}/code/` (markdown only)
...
> - **Documentation**: `guide-docs/build/[unit-name]/code/`
...
- Mark Code Generation stage as complete for this unit in guide-state.md
...
### Code Location Rules
- **Application code**: Workspace root only (NEVER guide-docs/)
- **Documentation**: guide-docs/ only (markdown summaries)
- **Read workspace root** from guide-state.md before generating code
