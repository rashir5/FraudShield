...
**Note**: This builds upon high-level component design from Application Design (DISCOVER phase)
...
- Read unit definition from `guide-docs/discover/application-design/unit-of-work.md`
- Read assigned stories from `guide-docs/discover/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `guide-docs/build/plans/{unit-name}-functional-design-plan.md`
...
### Step 6: Generate Functional Design Artifacts with Mermaid diagrams
- Create `guide-docs/build/{unit-name}/functional-design/business-logic-model.md`
- Create `guide-docs/build/{unit-name}/functional-design/business-rules.md`
- Create `guide-docs/build/{unit-name}/functional-design/domain-entities.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `guide-docs/build/[unit-name]/functional-design/`
...
- Mark Functional Design stage complete in guide-state.md
