...
- Read functional design artifacts from `guide-docs/build/{unit-name}/functional-design/`
...
### Step 4: Store Plan
- Save as `guide-docs/build/plans/{unit-name}-nfr-requirements-plan.md`
...
- Create `guide-docs/build/{unit-name}/nfr-requirements/nfr-requirements.md`
- Create `guide-docs/build/{unit-name}/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `guide-docs/build/[unit-name]/nfr-requirements/`
...
- Mark NFR Requirements stage complete in guide-state.md
