...
- Read functional design from `guide-docs/build/{unit-name}/functional-design/`
- Read NFR design from `guide-docs/build/{unit-name}/nfr-design/` (if exists)
...
- Focus on mapping to actual services (UPSKILLZ, Azure, GCP, on-premise)
...
### Step 4: Store Plan
- Save as `guide-docs/build/plans/{unit-name}-infrastructure-design-plan.md`
...
### Step 6: Generate Infrastructure Design Artifacts with Mermaid diagrams.
- Create `guide-docs/build/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `guide-docs/build/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `guide-docs/build/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `guide-docs/build/[unit-name]/infrastructure-design/`
...
- Mark Infrastructure Design stage complete in guide-state.md
