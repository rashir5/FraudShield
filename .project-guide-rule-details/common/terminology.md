# GUIDE-AI-SDP Terminology Glossary

## Core Terminology

### Phase vs Stage

**Phase**: One of the three high-level lifecycle phases in GUIDE-AI-SDP
- 🔵 **DISCOVER PHASE** - Planning & Architecture (WHAT and WHY)
- 🟢 **BUILD PHASE** - Design, Implementation & Test (HOW)
- 🟡 **DEPLOY PHASE** - Deployment & Monitoring (future expansion)
...
**Usage Examples**:
- ✅ "The BUILD phase contains 7 stages"
- ✅ "The Code Planning stage is always executed"
- ✅ "We're in the DISCOVER phase, executing the Requirements Assessment stage"
- ❌ "The Requirements Assessment phase" (should be "stage")
- ❌ "The BUILD stage" (should be "phase")
...
- Located in `guide-docs/plans/`
- Examples: `story-generation-plan.md`, `unit-of-work-plan.md`

### Artifacts
Generated outputs from executing plans.
- Located in various `guide-docs/` subdirectories
- Examples: `requirements.md`, `stories.md`, `design.md`

### State Files
Files tracking workflow progress and status.
- `guide-state.md`: Overall workflow state
- `audit.md`: Complete audit trail of all interactions

## Common Abbreviations

- **GUIDE-AI-SDP**: The G.U.I.D.E AI-Driven Software Development Practice
- **The G.U.I.D.E. DNA**
    - **G** Goals & Guardrails: Defining success metrics and boundaries.
    - **U**  Understanding: Deep-dive analysis of code and personas.
    - **I**  Integrate: Strategic synthesis of components.
    - **D**  Deliver: Validating readiness for production.
    - **E**  Evaluate: Continuous feedback loops for evolution.
- **NFR**: Non-Functional Requirements
- **UOW**: Unit of Work
- **API**: Application Programming Interface
- **CDK**: Cloud Development Kit (UPSKILLZ)
