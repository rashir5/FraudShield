# GUIDE-AI-SDP Adaptive Workflow Overview
...
• **DISCOVER PHASE**: Planning and architecture (Workspace Detection + conditional phases + Workflow Planning)
• **BUILD PHASE**: Design, implementation, build and test (per-unit design + Code Planning/Generation + Build & Test)
• **DEPLOY PHASE**: Placeholder for future deployment and monitoring workflows
...
## GUIDE-AI-SDP Three-Phase Workflow:
...
**🔵 DISCOVER PHASE** - Planning and Architecture
...
**🟢 BUILD PHASE** - Design, Implementation, Build and Test
...
**🟡 DEPLOY PHASE** - Placeholder
- Deploy: Placeholder for future deployment and monitoring workflows (PLACEHOLDER)

**Key Principles:**
- Phases execute only when they add value
- Each phase independently evaluated
- DISCOVER focuses on "what" and "why"
- BUILD focuses on "how" plus "build and test"
- DEPLOY is placeholder for future expansion
- Simple changes may skip conditional DISCOVER stages
- Complex changes get full DISCOVER and BUILD treatment