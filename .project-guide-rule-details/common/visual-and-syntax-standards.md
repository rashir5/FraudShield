# Visual and Syntax Validation Rules
...
5. Node labels containing periods or special marks (e.g., "G.U.I.D.E. by DeployPro") MUST be enclosed in double quotes within the Mermaid syntax to prevent parsing errors and ensure brand consistency.
