...
4. **Update State**: Mark phase as "PENDING" in `guide-state.md`
...
5. **Update State**: Mark phase as "SKIPPED" in `guide-state.md`
...
3. **If Restart Chosen**:
   ...
   - Mark stage as "IN PROGRESS" in `guide-state.md`
...
4. **If Confirmed**:
   ...
   - Reset all affected stages in `guide-state.md`
...
3. **Update State**: Ensure `guide-state.md` reflects current status
...
**On Resume**:
1. **Detect Existing Project**: Check for `guide-state.md`
...
2. **Update All Tracking**: Keep `guide-state.md`, plan files, and `audit.md` in sync
