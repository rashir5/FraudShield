...
- Load `common/session-resumption.md` for session resumption guidance
- Load `common/visual-and-syntax-standards.md` for content validation requirements
- Load `common/query-standards.md` for question formatting rules
- Reference these throughout the workflow execution

## MANDATORY: Content Validation
**CRITICAL**: Before creating ANY file, you MUST validate content according to `common/visual-and-syntax-standards.md` rules:
...
**See `common/query-standards.md` for complete question formatting rules including**:
...
2. Load all steps from `discover/workspace-detection.md`
3. Execute workspace detection:
   - Check for existing guide-state.md (resume if found)
...
2. Load all steps from `discover/reverse-engineering.md`
...
2. Load all steps from `discover/requirements-analysis.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this phase in audit.md
2. Load all steps from `discover/user-stories.md`
...
1. **MANDATORY**: Log any user input during this phase in audit.md
2. Load all steps from `discover/workflow-planning.md`
3. **MANDATORY**: Load content validation rules from `common/visual-and-syntax-standards.md`
...
6. **MANDATORY**: Validate all content before file creation per visual-and-syntax-standards.md rules
...
**Execution**:
1. **MANDATORY**: Log any user input during this phase in audit.md
2. Load all steps from `discover/application-design.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this phase in audit.md
2. Load all steps from `discover/units-generation.md`
3. Load reverse engineering artifacts (if brownfield)
4. Execute at appropriate depth (minimal/standard/comprehensive)
...
2. Load all steps from `build/functional-design.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this stage in audit.md
2. Load all steps from `build/nfr-requirements.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this stage in audit.md
2. Load all steps from `build/nfr-design.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this stage in audit.md
2. Load all steps from `build/infrastructure-design.md`
...
**Execution**:
1. **MANDATORY**: Log any user input during this stage in audit.md
2. Load all steps from `build/code-generation.md`
...
1. **MANDATORY**: Log any user input during this phase in audit.md
2. Load all steps from `build/build-and-test.md`
...
5. **Wait for Explicit Approval**: Ask: "**Build and test instructions complete. Ready to proceed to Deploy stage?**" - DO NOT PROCEED until user confirms
6. **MANDATORY**: Log user's response in audit.md with complete raw input
...
The Deploy stage will eventually include:
...
**Current State**: All build and test activities are handled in the BUILD phase.
...
- **Progress Tracking**: Update guide-state.md with executed and skipped stages
- **Complete Audit Trail**: Log ALL user inputs and AI responses in audit.md with timestamps
  - **CRITICAL**: Capture user's COMPLETE RAW INPUT exactly as provided
  - **CRITICAL**: Never summarize or paraphrase user input in audit log
  - **CRITICAL**: Log every interaction, not just approvals
- **Quality Focus**: Complex changes get full treatment, simple changes stay efficient
- **Content Validation**: Always validate content before file creation per visual-and-syntax-standards.md rules
- **NO EMERGENT BEHAVIOR**: Build phases MUST use standardized 2-option completion messages as defined in their respective rule files. DO NOT create 3-option menus or other emergent navigation patterns.
...
- **Stage-Level**: Track overall workflow progress in guide-state.md
...
│   │   └── build-and-test/
│   ├── deploy/                 # 🟡 DEPLOY PHASE (placeholder)
│   ├── guide-state.md
│   └── audit.md
```
